      ...
      <main>
        <div className="relative isolate">
          ...
          <div className="overflow-hidden">
            <div className="mx-auto max-w-[1180px] lg:my-20 my-10">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full ">
                  <HomeInfoTitle>Our Photo Gallery</HomeInfoTitle>
                  <HomeInfoSubTitle className="">
                    Choosing Grabbo means entrusting your care to one of the
                    most respected and compassionate fertility and diagnostic
