          ...
          <div>
            <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <div className="max-w-xl">
                <p className="mt-6">
                  Experience a seamless collaboration journey with our expert
                  designers, where your input is valued every step of the way,
                  resulting in a cohesive expectation.
                </p>
              </div>
            </div>
          </div>
