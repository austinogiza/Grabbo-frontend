    ...
    <Top>
      <FooterContainer>
        <Logo>
          <Logoimg src={logo} />
          <LogoText>
            Grabbo fertility clinic is an ultra-modern and super specialist
            fertility clinic designed to facilitate the provisions of efficiency
        ...
        <Section>
          ...
          <Sectiondets>
            <Sectionul>
              ...
              <Sectionli>
                <Link to="/departments">Department And Services</Link>
              </Sectionli>
              <Sectionli>
        ...
        <Section>
          ...
          <Sectiondets>
            <Footertext>Monday to Sunday 24 hours</Footertext>
            <Footertext>
            ...
            <Footersocial>
              <Wrappersocial>
                <Cover>
                  <a
                    href="https://facebook.com/grabbodiagnosticscentre/"
                    target="_blank"
                ...
                <Cover>
                  <a
                    href="https://www.instagram.com/grabbofertility/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    {" "}
